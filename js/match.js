	...
	data: {
		...
		cups: [
			...
			},
			{
				...
				matches: [
					...
					},
					{
						date: '20250216',
						pitch: '陽明交通大學北投田徑場',
						opponent: { name: '立農奧特曼', logo: '立農國小' },
						formation: '2-3-1',
						starters: ['GK-凱泰', 'RCB-維恩', 'LCB-紘豪', 'RM-宇正', 'CM-亮谷', 'LM-黃衍', 'CF-皓宇'],
						subs: [
							{
								number: 3,
								name: '晉丞',
				...
				matches: [
					{
						date: '20250327',
						pitch: '華中足球場',
						opponent: { name: '博愛小子', logo: '博愛國小' },
						formation: '1-2-1',
						starters: ['GK-善捷', 'CB-維恩', 'RM-宇正', 'LM-晉丞', 'CF-羿翔*'],
						subs: [
							{
								number: 11,
								name: '安璞*',
					...
					},
					{
						...
						formation: '1-2-1',
						starters: ['GK-善捷', 'CB-維恩', 'RM-宇正', 'LM-紘豪', 'CF-皓宇'],
						subs: [
							{
								number: 26,
								name: '昀宸*',
				...
				matches: [
					{
						...
						opponent: { name: '天母國小', logo: '天母國小' },
						formation: '3-3-1',
						starters: ['GK-善捷', 'RB-紘豪', 'CB-維恩', 'LB-晉丞', 'RM-宇正', 'CM-亮谷', 'LM-黃衍', 'CF-皓宇'],
						subs: [
							{
								number: 15,
								name: '凱泰',
					...
					},
					{
						date: '20250401',
						pitch: '朝馬足球場',
						opponent: { name: '廣福國小', logo: '廣福國小' },
						formation: '3-3-1',
						starters: ['GK-善捷', 'RB-紘豪', 'CB-維恩', 'LB-宇正', 'RM-晉丞', 'CM-亮谷', 'LM-黃衍', 'CF-皓宇'],
						subs: [
							{
								number: 15,
								name: '凱泰',
					...
					},
					{
						...
						opponent: { name: '石牌國小', logo: '石牌國小' },
						formation: '3-3-1',
						starters: ['GK-善捷', 'RB-晉丞', 'CB-維恩', 'LB-宇正', 'RM-皓宇', 'CM-亮谷', 'LM-紘豪', 'CF-黃衍'],
						subs: [
							{
								number: 15,
								name: '凱泰',
			...
			},
			{
				...
				system: '5人制',
				grade: 'U12',
				cover: '2025zhiqingcup',
				trophy: '亞軍',
				team: [
					{
						name: '國小',
						members: '晉丞、黃衍、紘豪、善捷、皓宇、凱泰、維恩、亮谷、柏燁、宥融、昕叡、宇正',
					},
				],
				note: '',
				matches: [
					{
						...
						opponent: { name: '幸安國小', logo: '幸安國小' },
						formation: '1-2-1',
						starters: ['GK-凱泰', 'CB-維恩', 'RM-亮谷', 'LM-黃衍', 'CF-皓宇'],
						subs: [
							{
								number: 3,
								name: '晉丞',
					...
					},
					{
						...
						opponent: { name: '基隆雷鷹', logo: '基隆雷鷹' },
						formation: '1-2-1',
						starters: ['GK-善捷', 'CB-亮谷', 'RM-維恩', 'LM-宇正', 'CF-黃衍'],
						subs: [
							{
								number: 3,
								name: '晉丞',
					...
					},
					{
						date: '20250615',
						pitch: '志清國小',
						opponent: { name: '基隆雷鷹', logo: '基隆雷鷹', formation: '基隆雷鷹-2' },
						formation: '1-2-1',
						starters: ['GK-善捷', 'CB-紘豪', 'RM-晉丞', 'LM-柏燁', 'CF-昕叡'],
						subs: [
							{
								number: 7,
								name: '黃衍',
					...
					},
					{
						date: '20250615',
						pitch: '志清國小',
						opponent: { name: '五常國小', logo: '五常國小', formation: '五常國小-2' },
						formation: '1-2-1',
						starters: ['GK-凱泰', 'CB-紘豪', 'RM-柏燁', 'LM-昕叡', 'CF-皓宇'],
						subs: [
							{
								number: 3,
								name: '晉丞',
					...
					},
					{
						date: '20250615',
						pitch: '志清國小',
						opponent: { name: '幸安國小', logo: '幸安國小', formation: '幸安國小-2' },
						formation: '1-2-1',
						starters: ['GK-善捷', 'CB-維恩', 'RM-宇正', 'LM-亮谷', 'CF-皓宇'],
						subs: [
							{
								number: 3,
								name: '晉丞',
