		...
		photos: [
			...
			},
			{
				...
				photos: [
					...
					{
						date: '11/26',
						opponents: 'MFA_White、Taipei Breakers',
			...
			},
			{
				...
				photos: [
					{
						date: '12/09',
						opponents: '立農國小、建安國小、忠義國小、石牌國小、TES',
				...
				photos: [
					{
						date: '03/10',
						opponents: '大同國小',
						url: `<a target="_blank" href="https://photos.app.goo.gl/LeAZSegxgejdkVgCA"><div class="img-wrap image-container m-3 px-5"><img src="img/media/20250310-cover.jpg" class="img-fluid image"><div class="middle"><div class="text">前往相簿</div></div></div></a>`,
					},
					{
						date: '03/12',
						opponents: '明湖國小',
			...
			},
			{
				...
				photos: [
					...
					},
					{
						date: '06/07',
						opponents: '磐石U12',
						url: `<a target="_blank" href="https://photos.app.goo.gl/gbbE93wrwHdNZa3HA"><div class="img-wrap image-container m-3 px-5"><img src="img/media/20250607-cover.jpg" class="img-fluid image"><div class="middle"><div class="text">前往相簿</div></div></div></a>`,
					},
				],
				icon: 'far fa-futbol',
			},
			...
			},
			{
				id: 64,
				cupName: '2025志清悍將畢業盃',
				cover: '20250615-cover',
				photos: [
					{
						date: '06/15',
						opponents: '幸好國小、基隆雷鷹、五常國小',
						url: `<a target="_blank" href="https://photos.app.goo.gl/bx5Y9RRvZo7cw9RY7"><div class="img-wrap image-container m-3 px-5"><img src="img/media/20250615-cover.jpg" class="img-fluid image"><div class="middle"><div class="text">前往相簿</div></div></div></a>`,
					},
				],
