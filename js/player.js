    ...
    data: {
        ...
        players: [{
            ...
            },
            {
                ...
                englishName: 'Ivan',
                title: '',
                info: '一年級下學期加入球隊，力量、鬥志和速度是他著名的武器。除了是球隊經驗最豐富的大門守護神，後衛、中場與前鋒等各種角色也都能駕馭自如，全能的身手是球隊不可或缺的重要戰力。曾於五年級上學期時被教練選為球隊副隊長。因身兼籃球隊長，於六年級時略有減少參加球隊活動的頻率',
            ...
            },
            {
                ...
                englishName: 'Otto',
                title: '',
                info: '帶著在俱樂部鍛練出的技術與天賦，於二年級下學期時加入球隊。長期在球隊後防上提供穩定的支援，把守大門的功力亦十分了得。五年級開始因個人規畫逐漸淡出賽場，以參與共同練習為主。',
