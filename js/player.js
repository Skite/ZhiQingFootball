	...
	data: {
		...
		players: [
			...
			},
			{
				...
				englishName: 'Thor',
				title: '',
				info: '球隊初始成員之一，在防守端下足苦功，不但是球隊後防十分重要的大將，亦曾數次在提攜後進的賽場上有卓越貢獻。進入中年級後加強了進攻意識與技巧，向全能球員之路邁進，並在六年級時逐漸站穩腳步，成為球隊不可或缺的重要角色。',
			...
			},
			{
				...
				englishName: 'Brad',
				title: '',
				info: '於二年級時加入球隊，無論力量或體能在隊上都名列前矛。同時是足球隊成員與交響樂團首席，為球隊提供能文能武的滿滿活力。四年級開始積極參與比賽，在鬥志與心態上都有明顯成長，並從五年級下學期起逐漸成為球隊重要的輪替球員，可惜因受傷勢影響，於六年級上學期時完全停止參加球隊活動。',
